...
SHAP_EXPLAINER_DRIVE_ID = "1p_UPJLnYCYrPUc-HiPWtRC7G_-fmPZRq"
SHAP_VALUES_DRIVE_ID = "1-4Hd-DXoveFyjz1TQoZ6rX7dKOGny2hm"
...
if not os.path.exists(MODEL_PATH):
    logging.error("❌ Model file not found! Ensure 'bert_lstm_model.pth' is available.")
